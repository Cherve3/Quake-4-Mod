...
idCVar si_buyModeStartingCredits(	"si_buyModeStartingCredits",	"600",			CVAR_GAME | CVAR_SERVERINFO | CVAR_INTEGER, "Amount of credits players start with in buying enable games" );
...
idCVar pm_thirdPersonRange(			"pm_thirdPersonRange",		"200",			CVAR_GAME | CVAR_FLOAT | CVAR_NORESET, "camera distance from player in 3rd person" );
