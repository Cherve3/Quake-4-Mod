...
const int IMPULSE_113			= 113;			// Buy item_comm    -Command Center
const int IMPULSE_114			= 114;			// Buy item_baracks -Barracks
const int IMPULSE_115			= 115;			// Buy item_depot   -Vehicle Depot
